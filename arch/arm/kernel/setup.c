...
void __init setup_arch(char **cmdline_p)
{
	...
	char console_settings[]="console=ram loglevel=7 no_console_suspend pwron=0x20000200c1 bootloader.ver=R750XXU1BNJ7 androidboot.hardware=qcom androidboot.baseband=msm androidboot.sec_atd.tty=/dev/ttyHSL0  mdss_mdp.panel=splash:dsi:0::qcom,mdss_dsi_samsung_oled_360p_cmd androidboot.dm_verity=disabled enforcing=0 androidboot.selinux=permissive ";
